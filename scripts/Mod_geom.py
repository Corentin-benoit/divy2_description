...
iteration_geom=1
message_publisher = rospy.Publisher("/divy2/thrusters/0/thrust", FloatStamped, queue_size=100)
...
def timer_callback(event):
    ...
    if (started):
        ...
        envoi.header = "header: seq: 0 stamp : secs: 0 nsecs: 0 frame_id:''";
        envoi.data = 5.0;
        message_publisher.publish(envoi)
            ...
            #rospy.loginfo("Data envoyée dans :")
            #rospy.loginfo(i)
            #rospy.loginfo("tq")
