...
def Gamepad_Publisher():
     ...
     while not rospy.is_shutdown():
         ...
         vect.data = 100*commande_envoyee #fonction qui retourne un vecteur 6*1 tq translation x y z rotation x y z

         rospy.loginfo("iteration")
         rospy.loginfo(iteration)
         rospy.loginfo("Published: ") #display the message on the terminal
         rospy.loginfo(vect.data) # peut pas concatener string et float
         ...
         # réinitialisation du vecteur de commandes à 0
         ABS_X = 0
         ABS_Lacet = 0
         ABS_Tanguage = 0
         ABS_Roulis = 0
